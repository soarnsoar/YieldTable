...
def RunTable(Year):
    ...
    conf_0_SR={
        ...
        'toCombine':{
            ...
            '$ggH2000\\times100$':{'list':['ggH_hww2000_c10brn00'],'scale':1.0},
            '$qqH2000\\times100$':{'list':['qqH_hww2000_c10brn00'],'scale':1.0},
        },
    ...
    dict_2_SR=ConvertToInputDict(conf_1_SR)
    dict_2_SB=ConvertToInputDict(conf_1_SB)
    dict_2_TOP=ConvertToInputDict(conf_1_TOP)
