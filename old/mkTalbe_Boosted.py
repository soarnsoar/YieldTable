...
def RunTable(Year,this_prod):
    ...
    conf_0_SR={
        'inputpath':'../'+Year+'/Datacards_'+Year+'/Datacard_M2000/__Boosted'+prod[0]+'_SR_MEKDTAG_M1500_C0.01/Event/shapes/histos___Boosted'+prod[0]+'_SR_MEKDTAG_M1500_C0.01.root',
    ...
    conf_0_SB={
        'inputpath':'../'+Year+'/Datacards_'+Year+'/Datacard_M2000/__Boosted'+prod[0]+'_SB_MEKDTAG_M1500_C0.01/Event/shapes/histos___Boosted'+prod[0]+'_SB_MEKDTAG_M1500_C0.01.root',
        'processlist':['ggH_hww2000_c10brn00','qqH_hww2000_c10brn00','qqWWqq','ggWW','MultiV','tW','TT','QCD','WmHWWlnuqq_M125','Wjets','DY','ZHWWlnuqq_M125','SingleTop','WpHWWlnuqq_M125'],
        'toCombine':{
            'MultiBoson':{'list':['MultiV','WmHWWlnuqq_M125','ZHWWlnuqq_M125','WpHWWlnuqq_M125'],'scale':1.0},
            'Top':{'list':['TT','SingleTop','tW'],'scale':1.0},
    ...
    conf_0_TOP={
        'inputpath':'../'+Year+'/Datacards_'+Year+'/Datacard_M2000/__Boosted'+prod[0]+'_TOP_MEKDTAG_M1500_C0.01/Event/shapes/histos___Boosted'+prod[0]+'_TOP_MEKDTAG_M1500_C0.01.root',
        'processlist':['ggH_hww2000_c10brn00','qqH_hww2000_c10brn00','qqWWqq','ggWW','MultiV','tW','TT','QCD','WmHWWlnuqq_M125','Wjets','DY','ZHWWlnuqq_M125','SingleTop','WpHWWlnuqq_M125'],
        'toCombine':{
            'MultiBoson':{'list':['MultiV','WmHWWlnuqq_M125','ZHWWlnuqq_M125','WpHWWlnuqq_M125'],'scale':1.0},
            'Top':{'list':['TT','SingleTop','tW'],'scale':1.0},
    ...
    conf_1_SR={
        'inputpath':'../'+Year+'/Datacards_'+Year+'/Datacard_M2000/__Boosted'+prod[0]+'_SR_UNTAGGED_M1500_C0.01/Event/shapes/histos___Boosted'+prod[0]+'_SR_UNTAGGED_M1500_C0.01.root',
        'processlist':['ggH_hww2000_c10brn00','qqH_hww2000_c10brn00','qqWWqq','ggWW','MultiV','tW','TT','QCD','WmHWWlnuqq_M125','Wjets','DY','ZHWWlnuqq_M125','SingleTop','WpHWWlnuqq_M125'],
        'toCombine':{
            'MultiBoson':{'list':['MultiV','WmHWWlnuqq_M125','ZHWWlnuqq_M125','WpHWWlnuqq_M125'],'scale':1.0},
            'Top':{'list':['TT','SingleTop','tW'],'scale':1.0},
    ...
    conf_1_SB={
        'inputpath':'../'+Year+'/Datacards_'+Year+'/Datacard_M2000/__Boosted'+prod[0]+'_SB_UNTAGGED_M1500_C0.01/Event/shapes/histos___Boosted'+prod[0]+'_SB_UNTAGGED_M1500_C0.01.root',
        'processlist':['ggH_hww2000_c10brn00','qqH_hww2000_c10brn00','qqWWqq','ggWW','MultiV','tW','TT','QCD','WmHWWlnuqq_M125','Wjets','DY','ZHWWlnuqq_M125','SingleTop','WpHWWlnuqq_M125'],
        'toCombine':{
            'MultiBoson':{'list':['MultiV','WmHWWlnuqq_M125','ZHWWlnuqq_M125','WpHWWlnuqq_M125'],'scale':1.0},
            'Top':{'list':['TT','SingleTop','tW'],'scale':1.0},
    ...
    conf_1_TOP={
        'inputpath':'../'+Year+'/Datacards_'+Year+'/Datacard_M2000/__Boosted'+prod[0]+'_TOP_UNTAGGED_M1500_C0.01/Event/shapes/histos___Boosted'+prod[0]+'_TOP_UNTAGGED_M1500_C0.01.root',
        'processlist':['ggH_hww2000_c10brn00','qqH_hww2000_c10brn00','qqWWqq','ggWW','MultiV','tW','TT','QCD','WmHWWlnuqq_M125','Wjets','DY','ZHWWlnuqq_M125','SingleTop','WpHWWlnuqq_M125'],
        'toCombine':{
            'MultiBoson':{'list':['MultiV','WmHWWlnuqq_M125','ZHWWlnuqq_M125','WpHWWlnuqq_M125'],'scale':1.0},
            'Top':{'list':['TT','SingleTop','tW'],'scale':1.0},
